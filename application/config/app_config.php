...
$config['app_admin_email_name'] = 'uNet - UEIPL';
...
$config['app_html_title'] = 'uNet - United Exploration India Private Limited';
$config['app_admin_html_title'] = 'uNet - United Exploration India Private Limited Admin';
$config['app_meta_keywords'] = 'Code Igniter project';
$config['app_meta_description'] = '';
$config['app_meta_author'] = 'Saikat Mahapatra';


$config['app_copy_right'] = 'Copyright '.date('Y').' &copy; United Exploration India Private Limited';
$config['app_admin_copy_right'] = 'Copyright &copy; '.date('Y').' <a href="http://unitedexploration.co.in/">United Exploration India Private Limited</a>. All rights reserved.';

...
class Cms extends CI_Controller {
    ...
    function render_datatable() {
        ...
        foreach ($data_rows as $result) {
            ...
            //add html for action
            $action_html = '';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/edit/' .$result['id']), '<i class="fas fa-pencil-alt"></i>', array(
            ...
            $action_html.='&nbsp;';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/delete/' . $result['id']), '<i class="fas fa-trash-alt"></i>', array(

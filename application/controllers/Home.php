...
class Home extends CI_Controller {
    ...
    function index() {
        ...
        $dashboard_stat['user'] = array('target_role' => '1', 'heading'=>'Employees', 'info_text'=>'','text_css'=>'','bg_css'=>'', 'digit_css'=>'text-primary', 'icon'=>'<i class="fas fa-fw fa-user" aria-hidden="true"></i>', 'count'=>$stat_user_count['data_rows'][0]['total'], 'url' => base_url('user/manage'));

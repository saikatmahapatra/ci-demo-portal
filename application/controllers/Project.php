...
class Project extends CI_Controller {
    ...
    function render_datatable() {
        ...
        foreach ($data_rows as $result) {
            ...
            /*$action_html.='&nbsp;';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/delete/' . $result['id']), '<i class="fas fa-times" aria-hidden="true"></i> Delete', array(
    ...
    function render_task_datatable() {
        ...
        foreach ($data_rows as $result) {
            ...
            //add html for action
            $action_html = '';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/edit_task/' .$result['id']), '<i class="fas fa-pencil-alt" aria-hidden="true"></i>', array(
                'class' => 'btn btn-sm btn-outline-secondary',
                'data-toggle' => 'tooltip',
                'data-original-title' => 'Edit',
                'title' => 'Edit',

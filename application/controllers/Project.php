...
class Project extends CI_Controller {
    ...
    function render_datatable() {
        ...
        foreach ($data_rows as $result) {
            ...
            //add html for action
            $action_html = '';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/edit/' .$result['id']), $this->common_lib->get_icon('edit'), array(
            ...
            $action_html.='&nbsp;';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/project_tasks/pid/' .$result['id']), $this->common_lib->get_icon('list'), array(
                'class' => 'btn btn-sm btn-light',
                'data-toggle' => 'tooltip',
            ...
            /*$action_html.='&nbsp;';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/delete/' . $result['id']), $this->common_lib->get_icon('delete') Delete', array(
    ...
    function render_task_datatable() {
        ...
        foreach ($data_rows as $result) {
            ...
            //add html for action
            $action_html = '';
            $action_html.= anchor(base_url($this->router->directory.$this->router->class.'/edit_task/' .$result['id']), $this->common_lib->get_icon('edit'), array(
                'class' => 'btn btn-sm btn-light',
                'data-toggle' => 'tooltip',
                'data-original-title' => 'Edit',
                'title' => 'Edit',

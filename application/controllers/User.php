...
class User extends CI_Controller {
    ...
    function login() {
		...
		$this->data['page_title'] = 'Log in to '.$this->config->item('app_name');
...
');
    ...
    function my_documents() {
        ...
        $this->data['all_uploads'] = $this->user_model->get_uploads($upload_related_to, $this->data['id'], NULL, NULL);
        if ($this->input->post('form_action') == 'file_upload') {
            $this->upload_my_documents_file();
        }
		$this->data['page_title'] = 'My Documents';
        $this->data['maincontent'] = $this->load->view($this->router->class.'/my_documents', $this->data, true);
        $this->load->view('_layouts/layout_default', $this->data);
    }
    ...
    function upload_my_documents_file() {
        ...
        if ($this->validate_uplaod_my_document_form_data() == true) {
            $upload_related_to = 'user'; // related to user, product, album, contents etc
    ...
    function validate_uplaod_my_document_form_data() {

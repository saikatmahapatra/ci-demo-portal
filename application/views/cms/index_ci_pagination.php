...
<div class="row">
	<div class="col-md-12">
		...
		<div class="grid-action-holder row my-2 px-3">
			<div class="col-md-8">
			<span class="mx-2"><i class="fa fa-flash text-success" aria-hidden="true"></i> Published Content</span>
			<span class="mx-2"><i class="fa fa-flash text-warning" aria-hidden="true"></i> Unpublished Content</span>
			</div>

            ...
            <div class="card-body">
                ...
                <div class="d-flex mb-2">
                    <div class="align-self-end ml-auto"> 
                        <a href="<?php echo base_url($this->router->directory.$this->router->class);?>" class="back-to-list btn btn-sm btn-link action-link"><?php echo $this->common_lib->get_icon('left_back'); ?> Return to List</a>
                    </div>
                </div>
                ...
                <div class="form-row">
					...
					?>
                            <label class="custom-control-label" for="send_email_notification">Send this as an email notification
                            </label>
                        </div>
                    </div>
                </div>

	...
	<div class="col-md-8">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<?php echo form_button(array('name' => 'submit_btn','type' => 'submit','content' => '<i class="d-none fa fa-fw fa-check-circle"></i> Create My Account','class' => 'btn btn-primary'));?>
				<a href="<?php echo base_url($this->router->directory.$this->router->class.'/login');?>" class="btn btn-secondary"><i class="d-none fa fa-fw fa-times-circle"></i> Cancel</a>
				<?php echo form_close(); ?>
				<div class="mt-3">

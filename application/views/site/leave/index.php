...
<div class="row">
    ...
    <div class="col-md-3">		
		...
		<div class="mt-2"><a id="clear_selected_days" class="btn btn-outline-secondary btn-sm" href="#"><i class="d-none fa fa-fw fa-times-circle"></i> Clear all selected days</a></div>
		<div class="mt-3">

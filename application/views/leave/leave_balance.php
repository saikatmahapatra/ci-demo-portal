            ...
            <div class="card-body">
                ...
                <div class="d-flex mb-2">
                    <div class="align-self-end ml-auto"> 
                        <a href="<?php echo base_url($this->router->directory.$this->router->class.'/view_leave_balance');?>" class="back-to-list"><?php echo $this->common_lib->get_icon('left_arrow'); ?> Return to List</a>
                    </div>
                </div>

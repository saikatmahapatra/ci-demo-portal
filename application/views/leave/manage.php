						...
						if(sizeof($data_rows)>0){
							foreach($data_rows as $row){
								...
								<tr>
									...
									<td>
									<a href="<?php echo base_url($this->router->directory.$this->router->class.'/details/'.$row['id'].'/'.$row['leave_req_id'].'/'.$this->uri->segment(2).'/'.$this->uri->segment(3));?>" class="btn btn-outline-info btn-sm" title="Details"><i class="fa fa-info-circle" aria-hidden="true"></i></a>

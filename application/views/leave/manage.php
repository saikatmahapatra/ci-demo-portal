...
<div class="row">
	<div class="col-md-12">
		...
		<div class="grid-action-holder row my-2">
			...
			<div class="col-md-12">
				<!-- <span class="mx-2"><i class="fa fa-flash text-primary" aria-hidden="true"></i> Applied</span>
				<span class="mx-2"><i class="fa fa-flash text-secondary" aria-hidden="true"></i> Pending</span>
				<span class="mx-2"><i class="fa fa-flash text-info" aria-hidden="true"></i> Processing</span>
				<span class="mx-2"><i class="fa fa-flash text-warning" aria-hidden="true"></i> Cancelled</span>
				<span class="mx-2"><i class="fa fa-flash text-success" aria-hidden="true"></i> Approved</span>
				<span class="mx-2"><i class="fa fa-flash text-danger" aria-hidden="true"></i> Rejected</span> -->

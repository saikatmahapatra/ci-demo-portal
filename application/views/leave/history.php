						...
						if(sizeof($data_rows)>0){
							foreach($data_rows as $row){
								...
								<tr>
									...
									<td>
									<a href="<?php echo base_url($this->router->directory.$this->router->class.'/details/'.$row['id'].'/'.$row['leave_req_id'].'/history');?>" class="btn btn-outline-info btn-sm" title="View Details"><i class="fa fa-lg fa-info-circle" aria-hidden="true"></i></a>
									</td>
								</tr>
								<?php
							}

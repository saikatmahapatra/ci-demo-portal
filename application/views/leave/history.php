...
<div class="row my-3">
	<div class="col-md-12">
		<div class="grid-action-holder row my-2 px-3 d-none">
			<div class="col-md-8">
				...
				if(sizeof($data_rows)>0){
					foreach($data_rows as $row){
						...
						<tr>
							...
							<td>
								<!-- <span class="small"><i class="fa fa-flash <?php echo $leave_status_arr[$row['leave_status']]['css'];?>" aria-hidden="true"></i></span>  -->

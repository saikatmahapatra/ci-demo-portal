...
<div class="row">
    <div class="col-lg-12 ci-dl">
        <div class="card ">
            <div class="card-header"><?php echo $this->app_lib->get_icon('card'); ?> Leave Details # <?php echo $row['leave_req_id'];?></div>
            <div class="card-body">
            <?php echo isset($alert_message) ? $alert_message : ''; ?>
                <dl class="row">
                    ...
                    <dd class="col-lg-10">
                        <?php echo $this->app_lib->display_date($row['leave_created_on'], TRUE, NULL);?>
                    </dd>
                    ...
                    <dd class="col-lg-10">
                        <?php echo $this->app_lib->display_date($row['leave_from_date'], NULL, NULL);?> to
                        <?php echo $this->app_lib->display_date($row['leave_to_date'], NULL, NULL);?></dd>
                ...
                <div class="row ci-wizard">
                    <div class="col-sm-4 ci-wizard-step complete">
                        ...
                        <?php
							...
							if($this->app_lib->get_sess_user('id') == $row['user_id']){
								...
								$edit_icon = $this->app_lib->get_icon('edit');
							}
                        ...
                        <div class="ci-wizard-info text-center">
                            ...
                            <div class="small">
                                <?php echo $this->app_lib->display_date($row['leave_created_on'], true);?>
                            </div>
                            ...
                            <div class="small">
                                <?php echo $this->app_lib->display_date($row['cancel_request_datetime'], true);?>
                            </div>
                            <div class="">
                            ...
                            <div class="small">
                                <?php echo $this->app_lib->display_date($row['cancellation_datetime'], true);?></div>
                            <div class="">
                    ...
                    <div class="col-sm-4 ci-wizard-step <?php echo $wizard_class; ?>">
                        ...
                        <div class="ci-wizard-info text-center">
                            ...
                            <div class="small">
                                <?php echo isset($row['supervisor_approver_datetime']) ? $this->app_lib->display_date($row['supervisor_approver_datetime'], true): ''; ?>
                            </div>
                            <div class="">
                    ...
                    <div class="col-sm-4 ci-wizard-step <?php echo $wizard_class; ?>">
                        ...
                        <div class="ci-wizard-info text-center">
                            ...
                            <div class="small">
                                <?php echo isset($row['director_approver_datetime']) ? $this->app_lib->display_date($row['director_approver_datetime'], true): ''; ?>
                            </div>
                            <div class="">
                ...
                <a href="<?php echo base_url($this->router->directory.$this->router->class.'/'.$this->uri->segment(5));?>"
                    class="btn-back btn btn-link action-link"><?php echo $this->app_lib->get_icon('left_back'); ?>Back</a>
            </div>
        </div>
        <!--/.card-body-->
    </div>

...
<div class="row">
    <div class="col-md-10">
		...
		<a href="<?php echo base_url($this->router->directory.$this->router->class.'/close_account/'.$this->encrypt->encode($row['id']));?>" class="btn btn-outline-danger">Close Account for Resisgned Employee</a>
        <?php echo form_close(); ?>
    </div>
</div>
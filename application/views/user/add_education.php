...
<div class="row">
    <div class="col-lg-6">
        <div class="card ci-card">
            <div class="card-header h6">Add Education Details</div>
            <!--/.card-header-->
            ...
            <?php echo isset($alert_message) ? $alert_message : ''; ?>
                ...
                <div class="form-row">
                    <div class="form-group col-12">
                        ...
                        <?php echo form_dropdown('academic_qualification', $arr_academic_qualification, set_value('academic_qualification'), array('class' => 'form-control',)); ?>
                        <?php echo form_error('academic_qualification'); ?>
                    </div>

                    <div class="form-group col-12">
                        <label for="academic_degree" class="required">Degree</label>
                        <?php echo form_dropdown('academic_degree', $arr_academic_degree, set_value('academic_degree'), array('class' => 'form-control','id' => 'academic_degree'));?>
                        <?php echo form_error('academic_degree'); ?>
                    </div>

                    <div class="form-group col-12">
                        <label for="academic_specialization" class="required">Specialization</label>
                        <?php echo form_dropdown('academic_specialization', $arr_academic_specialization, set_value('academic_specialization'), array('class' => 'form-control','id' => 'academic_specialization')); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo form_dropdown('academic_institute', $arr_academic_inst, set_value('academic_institute'), array('class' => 'form-control','id' =>'academic_institute'));?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" id="new_degree_name" name="new_degree_name"
...
<!-- Modal -->
<div class="modal fade" id="addSpecialization" tabindex="-1" role="dialog" aria-labelledby="addSpecialization"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" id="new_specialization_name" name="new_specialization_name"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" class="form-control" id="new_inst_name" name="new_inst_name"
                    placeholder="University/Board/Council Name">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>

		...
		<div class="card ci-card">
			...
			<?php echo isset($alert_message) ? $alert_message : ''; ?>
				<div class="action-btn-group">
					<a href="<?php echo base_url($this->router->directory.$this->router->class.'/create_account');?>" class="btn btn-sm btn-outline-success mr-2"> <?php echo $this->common_lib->get_icon('plus'); ?> Add New</a>

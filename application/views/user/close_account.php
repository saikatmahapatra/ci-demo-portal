	...
	<div class="col-md-12">
		<div class="card ci-card">
			...
			<div class="card-body">
				...
				<a href="<?php echo base_url($this->router->directory.$this->router->class.'/edit_user_profile/'.$row['id']);?>" class="ml-2 btn btn-secondary"><i class="fa fa-fw fa-times-circle"></i> Cancel</a>
				<?php echo form_close(); ?>

      ...
      <div class="card">
         ...
         <div class="card-body">
            ...
            <div class="form-group">
               <label class="required" for="password_reset_key">OTP</label>
            ...
            <div class="form-group">
               <label class="required" for="user_new_password">New Password</label>
            ...
            <div class="form-group">
               <label class="required" for="confirm_user_new_password">Confirm Password</label>

...
const path = {
    build_dist: './assets/dist',
    css: { src: './assets/src/scss/**/*.scss', dest: './assets/dist/css' },
    js: { src: './assets/src/js/**/*.js', dest: './assets/dist/js' },
    img: { src: './assets/src/img/**/*', dest: './assets/dist/img' }
};
